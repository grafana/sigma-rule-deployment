...
function getInputs() {
  ...
  if (isGitHubActions) {
    ...
    return {
      ...
      additionalContent: core.getInput('additional_content') || process.env.ADDITIONAL_CONTENT || '',
    ...
    return {
      ...
      additionalContent: inputs.additional_content || process.env.ADDITIONAL_CONTENT || '',
